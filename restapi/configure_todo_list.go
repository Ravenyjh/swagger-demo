...
import (
	...
	"demo/restapi/operations"
	"demo/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swagger-demo --name TodoList --spec ../swagger.yml --principal interface{}
